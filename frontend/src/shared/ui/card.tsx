/**
 * SYNAPSE Atlas Console — Card primitive (shadcn copy-in).
 */
...
export const CardTitle = forwardRef<HTMLHeadingElement, HTMLAttributes<HTMLHeadingElement>>(
  ({ className, ...props }, ref) => (
    <h3
      ref={ref}
      className={cn("text-ops-lg font-semibold leading-tight tracking-tight", className)}
      {...props}
    />
  ),
);
...
export const CardDescription = forwardRef<HTMLParagraphElement, HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => (
    <p ref={ref} className={cn("text-ops-sm text-muted-fg", className)} {...props} />
  ),
);
