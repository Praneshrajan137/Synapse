...
| **2r** | 26.2 · 26.3 · 27.2 · 27.3 · 27.4 · 27.5 | 6 | **Adopted debt, and it goes BEFORE session 2 — see below.** Dispatch and commit the regeneration; clear `mypy --strict orchestrator/`; confirm `uplift-verify` executes. |
...
independent and either may go first.
