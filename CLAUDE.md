...
- `.github/workflows/live-truth.yml` is the staleness watchdog (C48): 4x/day it asserts deployed `/version` == main HEAD + container truth, and auto-opens a `sev1` issue. Its cron MUST stay inside the VM's ADR-036 up-window (09:00–23:00 IST)
