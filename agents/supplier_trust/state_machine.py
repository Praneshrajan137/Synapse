...
TRANSITIONS: list[Transition] = [
    Transition(
        ...
        "trust_evaluation_triggered",
        guard="neo4j_healthy and kafka_healthy",
        timeout_seconds=2.0,
    ),
    Transition(
        AgentState.PROPOSING, AgentState.DEBATING, "proposal_submitted", timeout_seconds=5.0
    ),
    Transition(
        AgentState.DEBATING, AgentState.EXECUTING, "consensus_reached", timeout_seconds=30.0
    ),
    Transition(
