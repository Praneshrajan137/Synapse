...
class TestMetamorphicRelations:
    ...
    def test_mr_ds_001_higher_anomaly_higher_alert(
        ...
        result_1x = pipeline.detect(DisruptionRequest(
        ...
        result_2x = pipeline_2.detect(DisruptionRequest(
            node_ids=[f"NODE-{i}" for i in range(5)],
    ...
    def test_mr_ds_001_ensemble_score_monotonic(
        ...
        result_small = pipeline.detect(DisruptionRequest(
            node_ids=[f"NODE-{i}" for i in range(5)],
        ...
        result_large = pipeline_2.detect(DisruptionRequest(
            node_ids=[f"NODE-{i}" for i in range(5)],
