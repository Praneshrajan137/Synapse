...
class TestMetamorphicRelations:
    def test_mr_fg_001_expired_implies_markdown(self, pipeline: FreshnessGuardianPipeline) -> None:
        """MR-FG-001: days_to_expiry = 0 -> markdown_applied = True."""
